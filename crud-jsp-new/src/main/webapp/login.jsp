    ...
    <div class="div-menu">
        ...
        <div class="op">
            ...
            <div class="div-login">
                ...
                <form id="form-login" method="POST" action="controladora">
                    ...
                    <input type="hidden" name="acao" value="Authentication">
                    ...
                    <button id="btnLogin" name="btnLogin" type="submit" class="btn btn-primary"
                            onclick="return valida()">Login api
                    </button>
